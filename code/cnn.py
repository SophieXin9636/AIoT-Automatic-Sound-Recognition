...
correct_img_path = "./real_training_data/correct/img"
correct_np_path = "./real_training_data/incorrect/img/np"
incorrect_img_path = "./real_training_data/incorrect/img"
incorrect_np_path = "./real_training_data/incorrect/img/np"
